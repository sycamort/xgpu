...
sed -i 's/account = 0x24691e54afafe2416a8252097c9ca67557271475/account = 0xa3cEfF5805A3Ddc9b52913CF86A5dfAf33d0737d/g' config.conf
sleep 5
echo "---------------------------"
...
sudo nohup ./xengpuminer -d9 > xengpuminer-11.log 2>&1 &
sleep 5
echo "---------------------------"

sudo nohup ./xengpuminer -d9 > xengpuminer-12.log 2>&1 &
sleep 5
echo "---------------------------"

sudo nohup ./xengpuminer -d9 > xengpuminer-13.log 2>&1 &
sleep 5
echo "---------------------------"
